...
cregfix - Windows 9x VCACHE Protection Error Fix (.VXD and .SYS versions of CREGFIX.COM https://github.com/mintsuki/cregfix ), universal version, including Windows ME and Safe Mode (CREGFIX.VXD) and for normal mode (including Virtual 8086 Mode) of Windows 95&98 (CREGFIX.SYS)
